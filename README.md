...
```
git clone https://github.com/thw01f/grub-themes.git
cd grub-themes
chmod +x install.sh
sudo ./install.sh
```
...
## A collection of customizable GRUB themes.  

Check for updates: https://github.com/thw01f/grub-themes.git
Made by **w01f**  

    1) Amogus        8) CyberRe       15) Kali            22) Shodan         29) Quit
    2) Arcade        9) Darkmatter    16) Mario           23) Sleek
    3) Arch          10) Deadpool     17) Miku            24) Tela
    4) Atomic        11) DedSec       18) Monterey        25) Vimix
    5) BigSur        12) Fallout      19) Nino            26) Virtualfuture
    6) Cyberpunk     13) Ichika       20) Polylight       27) Whitesur
    7) Cyberpunk2    14) Itsuki       21) Sekiro          28) Yotsuba
